...
alter table product_tag add constraint fk_product_tag_product foreign key (product_product_id) references user (product_id) on delete restrict on update restrict;
...
alter table stock_item add constraint fk_stock_item_product_product_id foreign key (product_product_id) references user (product_id) on delete restrict on update restrict;
